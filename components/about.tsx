          ...
          >
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-white/80 leading-relaxed">
                I&apos;m a passionate full-stack developer with a deep
                fascination for financial markets. I combine my technical
                expertise with financial analysis to create innovative solutions
                for trading, portfolio management, and market research. When
                I&apos;m not coding, you&apos;ll find me analyzing market
                trends, backtesting trading strategies, or diving deep into
                financial data.
              </p>
              <p className="text-white/80 leading-relaxed mt-4">
                My unique blend of programming skills and financial knowledge
                allows me to build sophisticated trading tools, automated
                analysis systems, and data visualization platforms that help
                make sense of complex market movements.
              </p>
            </div>
          </motion.div>
